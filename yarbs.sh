...
preinstallmsg() { \
	dialog --title "Let's begin" --yes-label "Start" --no-label "No, undo everything" --yesno "The installation will now begin, but will take some time.\\n\\nPress <Start> and the system will begin installation" 13 60 || { clear; exit; }
	}
